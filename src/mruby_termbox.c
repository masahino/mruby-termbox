...
static void mrb_termbox_event_free(mrb_state *mrb, void *ptr) {
/*  if (ptr != NULL) {
    free(ptr);
  }
*/
}
const static struct mrb_data_type mrb_termbox_event_data_type = { "Termbox::Event", mrb_termbox_event_free };
...
{
  struct RClass *termbox_module, *termbox_event;
